...
An intelligent, prompt-driven Email Productivity Agent that automates email management using AI.

The system processes a real or mock inbox and performs:
...
### System Workflow
1. Emails are loaded (mock inbox or Gmail API)
2. Emails are categorized using Gemini API
3. Action items and deadlines are extracted
4. Draft replies are generated
5. A chat agent allows users to interact with emails
6. Prompts can be edited in the UI (“Prompt Brain”), which changes AI behavior without changing code
